...
Another use case of slice99 is zero-copy parsers: you can return slices from your parser that point to actual data -- no need to dynamically allocate new memory areas to append `'\0'` each time (slices need not be null-terminated).
