...
Another use case of slice99 is zero-copy parsers. The trick is that you can construct slices pointing to actual data without dynamically allocating new memory areas to append `'\0'` each time (slices need not be null-terminated).
